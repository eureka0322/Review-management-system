...
<main class="common_main">
  ...
  <div class="top_draft_box mypage_recruit">
              ...
              <h2 class="top_draft_item_title">Pal教室NEO</h2>
      <p class="top_draft_place">株式会社パル・オネスト　Pal教室NEO / 埼玉県 朝霞市</p>
      <p class="top_draft_num">
          <span>5</span>/8 項目完了
           (承認待ちあり)         </p>
              <a href="https://hoikuhiroba-kuchikomi.com/answer/821" class="top_draft_detail_btn">口コミを追記する</a>
          </div>
</li>                                </ul>
          </div>
      </div>
